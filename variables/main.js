...
////////////// 1  BONUS
let años = parseInt(prompt("Ingresa un numero de años"));
...
////////////// 2  BONUS
let cantidadDeKilometrosARecorrer = parseFloat(window.prompt("Ingrese distancia en Km"));
let velocidadPromedio = parseFloat(window.prompt(" Ingrese velocidad promedio en Km/h "));
let valorKmPorMin = velocidadPromedio / 60;
let tiempoEstimadoEnMinutos = Math.round(cantidadDeKilometrosARecorrer / valorKmPorMin) ;

console.log(tiempoEstimadoEnMinutos);
alert ("El tiempo en minutos es:" + " " + tiempoEstimadoEnMinutos);


////////////////////// 3 BONUS 
let bruto = parseInt(window.prompt("Ingrese sueldo bruto"));
let obraSocial = (bruto * 3) / 100;
let ley = (bruto * 11) / 100;
let jubilacion = (bruto * 3) / 100;
let neto = bruto - (obraSocial + ley + jubilacion); 

alert(`Cobras en mano ${neto}`)
console.log(neto);
