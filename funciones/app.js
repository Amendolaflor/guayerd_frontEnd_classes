...
const drink = prompt(
  `Ingrese el codigo de la bebida que desea pedir: \n 1:cerveza \n 2:jugo \n 3:agua`
);
...
const userOption = prompt(
  `Elija una opcion de medida de tiempo: \n 1: horas \n 2: minutos \n 3: segundos`
);
...
const quantGrades = parseInt(
  prompt("Cuantas claificaciones tuviste en tu ultimo cuatrimestre?")
);
const grades = [];
let sum = 0;
